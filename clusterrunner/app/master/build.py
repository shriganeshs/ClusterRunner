...
from clusterrunner.app.master.build_fsm import BuildFsm, BuildEvent, BuildState
...
from clusterrunner.app.util import util
from clusterrunner.app.util.conf.configuration import Configuration
from clusterrunner.app.util.counter import Counter
from clusterrunner.app.util.exceptions import ItemNotFoundError
import clusterrunner.app.util.fs
from clusterrunner.app.util.log import get_logger
...
class Build(object):
    ...
    def prepare(self, subjob_calculator):
        ...
        clusterrunner.app.util.fs.create_dir(self._build_results_dir())
    ...
    def _handle_subjob_payload(self, subjob_id, payload):
        ...
        try:
            clusterrunner.app.util.fs.write_file(payload['body'], result_file_path)
            clusterrunner.app.util.fs.extract_tar(result_file_path, delete=True)
    ...
    def _create_build_artifact(self):
        ...
        self._artifacts_archive_file = clusterrunner.app.util.fs.compress_directory(self._build_results_dir(), 'results.tar.gz')
