...
class Build(object):
    ...
    def __init__(self, build_request):
        ...
        self._state_machine = BuildFsm(self._build_id, {
    ...
    def build_id(self):
        ...
        :rtype: int
        """
        # WIP(joey): Refactor/rename method "build_id()" to property "id".
    ...
    def mark_started(self):
        """
        Mark a build as started. A build is considered started when it has slaves allocated to it.
        """
        self._state_machine.trigger(BuildEvent.START)
    ...
    def _on_enter_canceled_state(self):
